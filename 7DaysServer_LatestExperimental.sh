...
sudo echo -e "ExecStartPre=/home/$mylogin/steamcmd +login anonymous +force_install_dir /home/$mylogin/server +app_update 294420 -beta latest_experimental-unstable +quit" >> /lib/systemd/system/7days.service
